...
window.I18N = {
 ...
 // Tanya AI (ai_*)
 ai_title: { bm: 'Tanya 10 CAMP (Pembantu AI)', en: 'Ask 10 CAMP (AI Assistant)' },
 ai_sub: { bm: 'Tanya apa-apa pasal business dalam BM/EN/mix. Contoh: "Berapa sales last week?" · "Top 5 products bulan ni?" · "Customer mana spend paling banyak?" · "Stock mana yang nak habis?"', en: 'Ask anything about the business in BM/EN/mix. Examples: "Sales last week?" · "Top 5 products this month?" · "Which customer spent the most?" · "Which stock is running low?"' },
 ai_example_sales: { bm: 'Sales bulan ni vs lepas', en: 'Sales this month vs last' },
 ai_example_top5: { bm: 'Top 5 produk', en: 'Top 5 products' },
 ai_example_top_customers: { bm: 'Top customers', en: 'Top customers' },
 ai_example_low_stock: { bm: 'Stok rendah', en: 'Low stock' },
 ai_example_aov: { bm: 'AOV', en: 'AOV' },
 ai_example_staff_perf: { bm: 'Prestasi staf', en: 'Staff performance' },
 ai_input_ph: { bm: 'Tulis soalan… (Enter untuk hantar)', en: 'Type a question… (Enter to send)' },
 ai_send_btn: { bm: 'Tanya', en: 'Ask' },
