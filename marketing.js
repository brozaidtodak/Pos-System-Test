...
window.__mktPrintReport = function(){
 ...
 win.document.write('<!DOCTYPE html><html><head><title>Marketing Report</title><style>body{font-family:Arial,sans-serif;max-width:760px;margin:auto;padding:28px;color:#111;}h1{font-size:20px;}h2{font-size:15px;color:#CD7C32;margin-top:22px;}table{width:100%;border-collapse:collapse;font-size:13px;margin-top:8px;}th,td{border:1px solid #999;padding:6px 8px;text-align:left;}th{background:#f3f4f6;}@media print{button{display:none;}}</style></head><body>'
  ...
  + '<button onclick="window.print()" style="position:fixed;top:20px;right:20px;padding:10px 20px;background:#CD7C32;color:#fff;border:none;border-radius:6px;font-weight:bold;cursor:pointer;">Print</button>'
  + '</body></html>');
 win.document.close();
};
